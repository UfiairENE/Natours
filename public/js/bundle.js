...
var displayMap = function displayMap(locations) {
  try {
    ...
    console.log(err); // showAlert('error', err);
  }
};
...
var hideAlert = function hideAlert() {// const el = document.getElementById('id07');;
...
var showAlert = function showAlert(type, msg) {
  ...
  if (type === 'error') {
    ...
    document.getElementById('msg').innerText = "".concat(msg);
  } else {
    document.getElementById('id09').style.display = 'block';
    document.getElementById('msg1').innerText = "".concat(msg);
  }
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in Successfully'); // console.log(email, password)
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51J9orFB77MW7oryyKVX2kbd5sQnoMjVy6YNxfez7v8yTEWCdDYW612MLQsoeOEjqtWuvzU32yDkt43RTXLX5657s00Z6OgRu7L');
            _context.next = 4;
...
exports.updateReview = exports.deleteReview = exports.review = void 0;
...
var review = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_review, rating, tour, user) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review created Successfully'); // console.log(email, password)
  ...
  return function review(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review Deleted Successfully'); // console.log(email, password)
...
var updateReview = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(review, rating, reviewId, user) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review updated Successfully'); // console.log(email, password)
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Registration Successful'); // console.log(email, password)
          ...
          case 7:
            ...
            if (_context.t0.response.data.message == 'Something went very wrong') {
...
exports.getId = exports.tourDelete = exports.tourUpdate = exports.tourCreate = void 0;
...
var tourCreate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(startDates, name, duration, maxGroupSize, difficulty, price, summary, description, imageCover, image1, image2, image3) {
    var data, transformInToFormObject, value, appL, appG, appl, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            transformInToFormObject = function _transformInToFormObj(data) {
              var formData = new FormData();

              var _loop = function _loop(key) {
                if (Array.isArray(data[key])) {
                  data[key].forEach(function (obj, index) {
                    var keyList = Object.keys(obj);
                    keyList.forEach(function (keyItem) {
                      var keyName = [key, "[", index, "]", ".", keyItem].join("");
                      formData.append(keyName, obj[keyItem]);
                    });
                  });
                } else if (_typeof(data[key]) === "object") {
                  for (var innerKey in data[key]) {
                    formData.append("".concat(key, ".").concat(innerKey), data[key][innerKey]);
                  }
                } else {
            ...
            appl(startDates, value); // console.log(value);
          ...
          case 14:
            ...
            if (res.data.status === 'success') {
              // tour = ;
              (0, _alerts.showAlert)('success', 'Tour created Successfully'); // console.log("New Tour  ", res.data.data.data)
  ...
  return function tourCreate(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12) {
    return _ref.apply(this, arguments);
  };
}();

exports.tourCreate = tourCreate;

var tourUpdate = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tourId, value) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/tours/i/".concat(tourId),
              data: value
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Update Done Successfully'); // console.log(email, password)
  ...
  return function tourUpdate(_x13, _x14) {
    return _ref2.apply(this, arguments);
  };
}();

exports.tourUpdate = tourUpdate;

var tourDelete = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Tour Deleted Successfully'); // console.log(email, password)
  ...
  return function tourDelete(_x15) {
    return _ref3.apply(this, arguments);
  };
}();

exports.tourDelete = tourDelete;
...
exports.userDelete = exports.userUpdate = exports.userCreate = void 0;
...
var userCreate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, tour, user, userId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User created Successfully'); // console.log(email, password)
  ...
  return function userCreate(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var userUpdate = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, role, userId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User updated Successfully'); // console.log(email, password)
  ...
  return function userUpdate(_x6, _x7, _x8, _x9) {
    return _ref2.apply(this, arguments);
  };
}();
...
var userDelete = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User Deleted Successfully'); // console.log(email, password)
  ...
  return function userDelete(_x10) {
    return _ref3.apply(this, arguments);
  };
}();
...
var loginForm2 = document.querySelector('.f1');
var logOutBtn = document.querySelector('.nav__el--logout');
var logOutBtn2 = document.querySelector('.log2');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookButton = document.getElementById('book-tour');
var bookButton2 = document.getElementById('book-tour2');
var reviewForm = document.querySelector('.review-form');
var reviewForm2 = document.querySelector('.form--review');
var registerForm = document.querySelector('.form--register');
var registerForm2 = document.querySelector('.sregister');
var reviewDeleteBtn = document.querySelectorAll('.review-delete');
var reviewDeleteBtn2 = document.getElementById('sreview-delete');
var reviewUpdate = document.getElementById('up');
var tourDeleteBtn = document.querySelectorAll('.tour-delete');
var tourDeleteBtn2 = document.getElementById('stour-delete');
var userDeleteBtn = document.querySelectorAll('.user-delete');
var userDeleteBtn2 = document.getElementById('suser-delete');
var userUpdateForm = document.querySelector('.update-user-form');
var userCreateForm = document.querySelector('.create-user-form');
var tourCreateForm = document.querySelector('.create-tour-form');
var tourUpdateForm = document.querySelector('.update-tour-form'); //VALUES
//DELEGATION
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    document.getElementById('btn--save-password').innerText = ' Updating...'; // console.log(document.querySelector('#btn--save-password'))
...
if (bookButton2) {
  bookButton2.addEventListener('click', function (e) {
    e.target.innerText = ' Processing...'; // console.log("trying")
...
if (reviewUpdate) {
  if (reviewForm) {
    reviewForm.addEventListener('submit', function (e) {
      e.preventDefault();
      var reviewI = document.getElementById('review').value;
      var rating = document.getElementById('rating').value;
      var reviewId = document.getElementById('reviewId').value;
      var user = document.getElementById('user').value;
      (0, _review.updateReview)(reviewI, rating, reviewId, user);
    });
  }
  ...
  if (reviewForm2) {
    reviewForm2.addEventListener('submit', function (e) {
      e.preventDefault();
      var reviewI = document.getElementById('sreview').value;
  ...
  if (reviewForm) {
    reviewForm.addEventListener('submit', function (e) {
      ...
      var user = document.getElementById('user').value;
      (0, _review.review)(reviewI, rating, tour, user);
    });
  }
  ...
  if (reviewForm2) {
    reviewForm2.addEventListener('submit', function (e) {
      ...
      var reviewI = document.getElementById('sreview').value;
      var rating = document.getElementById('srating').value;
      var tour = document.getElementById('stour').value;
      var user = document.getElementById('suser').value;
      (0, _review.review)(reviewI, rating, tour, user);
    });
  }
...
if (reviewDeleteBtn) {
  reviewDeleteBtn.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.target.innerText = ' Deleting...';
      var reviewId = e.target.dataset.reviewId;
      (0, _review.deleteReview)(reviewId); // setTimeout(() => {
...
if (reviewDeleteBtn2) {
  reviewDeleteBtn2.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.target.innerText = ' Deleting...';
      var reviewId = e.target.dataset.reviewId;
      (0, _review.deleteReview)(reviewId); // setTimeout(() => {
...
if (tourDeleteBtn) {
  tourDeleteBtn.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.target.innerText = ' Deleting...';
      var tourId = e.target.dataset.tourId;
      (0, _tour.tourDelete)(tourId); // setTimeout(() => {
      //     e.target.innerText = 'Deleted'
      // }, 1000);
    });
  });
...
if (tourDeleteBtn2) {
  tourDeleteBtn2.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.target.innerText = ' Deleting...';
      var tourId = e.target.dataset.tourId;
      (0, _tour.tourDelete)(tourId); // setTimeout(() => {
...
if (userDeleteBtn) {
  userDeleteBtn.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.target.innerText = ' Deleting...';
      var userId = e.target.dataset.userId;
      (0, _users.userDelete)(userId); // setTimeout(() => {
      //     e.target.innerText = 'Deleted'
      // }, 1000);
    });
  });
...
if (userDeleteBtn2) {
  userDeleteBtn2.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.target.innerText = ' Deleting...';
      var userId = e.target.dataset.userId;
      (0, _users.userDelete)(userId); // setTimeout(() => {
...
if (userUpdateForm) {
  userUpdateForm.addEventListener('submit', function (e) {
    ...
    (0, _users.userUpdate)(name, email, role, userId);
  });
}
...
if (tourCreateForm) {
  tourCreateForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var name, duration, maxGroupSize, difficulty, description, summary, price, startDates1, startDates, imageCover, image1, image2, image3;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              price = document.getElementById('price').value; // start startDates

              startDates1 = document.querySelectorAll('.date'); // console.log(startDates1);
              // startDates1.forEach

              startDates = new Array();
              startDates1.forEach(function (el) {
                startDates.push(el.value);
              });
              console.log("Date values", startDates); // console.log(startLocation.coordinates);
              ...
              image3 = document.getElementById('image3').files[0]; // console.log(b);
              ...
              (0, _tour.tourCreate)(startDates, name, duration, maxGroupSize, difficulty, price, summary, description, imageCover, image1, image2, image3);
...
if (tourUpdateForm) {
  tourUpdateForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var tourId, descriptionSub, type, coordinates, address, guides1, guides, i, descriptionL, typeL, coordinatesP, coordinatesL, dayL, locations, startLocation, valueS;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              tourId = document.getElementById('tour').value; // userUpdate(name, email, role, userId);
              // start location

              descriptionSub = document.getElementById('descriptionSub').value;
              type = document.getElementById('type').value;
              coordinates = document.getElementById('coordinates').value.split(','); // const coordinates1 = ((document.getElementById('coordinates').value).split(','));
              // var coordinates = new Array();

              coordinates[0] = Number(coordinates[0]);
              coordinates[1] = Number(coordinates[1]); // console.log(coordinates)
              // coordinates1.forEach(el => {
              //     coordinates.push(Number(el));
              // });

              address = document.getElementById('address').value; // Guides

              guides1 = document.querySelectorAll('.gname'); // guides = guides.map(el => el.value);

              guides = new Array();
              i = 0;
              guides1.forEach( /*#__PURE__*/function () {
                var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(el) {
                  ...
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          a = el.value.toLowerCase(); // console.log(el.value, a);
              ...
              descriptionL = document.getElementById('descriptionL').value;
              typeL = document.getElementById('typeL').value;
              coordinatesP = document.getElementById('coordinatesL').value.split(',');
              coordinatesL = new Array(); // console.log("coordinatesL", coordinatesP);

              coordinatesL[0] = Number(coordinatesP[0]);
              coordinatesL[1] = Number(coordinatesP[1]); // const addressL = document.getElementById('addressL').value;

              dayL = document.getElementById('dayL').value;
              locations = [{
              ...
              (0, _tour.tourUpdate)(tourId, valueS);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36275" + '/');
